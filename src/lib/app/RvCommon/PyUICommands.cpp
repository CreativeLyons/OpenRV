...
namespace Rv
{
    ...
    static PyObject* qvariantToPyObject(QVariant::Type type, const QVariant& value)
    {
        ...
        //  reference to the calling code, so we must INCREF the pyobject we
        //  return.
        //
    ...
    static QVariant pyObjectToQVariant(PyObject* pyobj)
    {
        if (PyBool_Check(pyobj))
            return QVariant(pyobj == Py_True ? true : false);
        else if (PyLong_Check(pyobj))
            return QVariant(int(PyLong_AsLong(pyobj)));
        else if (PyFloat_Check(pyobj))
            return QVariant(PyFloat_AsDouble(pyobj));
        else if (PyBytes_Check(pyobj))
            return QVariant(QString(PyBytes_AsString(pyobj)));
    ...
    static PyObject* readSettings(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        const char* group;
        const char* name;
    ...
    static PyObject* writeSettings(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        const char* group;
        const char* name;
    ...
    static void popupMenuInternal(PyObject* pylist, QPoint& location)
    {
    ...
    static PyObject* popupMenu(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        Session* s = Session::currentSession();
        RvDocument* rvDoc = (RvDocument*)s->opaquePointer();
    ...
    static PyObject* popupMenuAtPoint(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        Session* s = Session::currentSession();
        RvDocument* rvDoc = (RvDocument*)s->opaquePointer();
    ...
    static PyObject* sessionWindow(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        Session* s = Session::currentSession();
    ...
    static PyObject* sessionGLView(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        Session* s = Session::currentSession();
    ...
    static PyObject* sessionBottomToolBar(PyObject* self, PyObject* args)
    {
        PyLockObject locker;
        Session* s = Session::currentSession();
        PyObject* ret = Py_None;
    ...
    static PyMethodDef localmethods[] = {
        ...
        {"writeSettings", writeSettings, METH_VARARGS, ""},

        {"popupMenu", popupMenu, METH_VARARGS, ""},

        {"popupMenuAtPoint", popupMenuAtPoint, METH_VARARGS, ""},
