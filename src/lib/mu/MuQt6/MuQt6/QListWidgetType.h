...
namespace Mu
{
    ...
    public:
        ...
        QListWidgetType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        bool dropMimeData_pub_parent(int index, const QMimeData* data, Qt::DropAction action)
        {
