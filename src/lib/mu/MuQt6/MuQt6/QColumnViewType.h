...
#ifndef __MuQt6__QColumnViewType__h__
#define __MuQt6__QColumnViewType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QColumnViewType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        MuQt_QColumnView(Pointer muobj, const CallEnvironment*, QWidget* parent);
    ...
    public:
        QAbstractItemView* createColumn_pub(const QModelIndex& index) { return createColumn(index); }

        QAbstractItemView* createColumn_pub_parent(const QModelIndex& index) { return QColumnView::createColumn(index); }

        void initializeColumn_pub(QAbstractItemView* column) const { initializeColumn(column); }

        void initializeColumn_pub_parent(QAbstractItemView* column) const { QColumnView::initializeColumn(column); }
        ...
        int horizontalOffset_pub_parent() const { return QColumnView::horizontalOffset(); }
        ...
        void resizeEvent_pub_parent(QResizeEvent* event) { QColumnView::resizeEvent(event); }

        void rowsInserted_pub(const QModelIndex& parent, int start, int end) { rowsInserted(parent, start, end); }

        void rowsInserted_pub_parent(const QModelIndex& parent, int start, int end) { QColumnView::rowsInserted(parent, start, end); }

        void scrollContentsBy_pub(int dx, int dy) { scrollContentsBy(dx, dy); }

        void scrollContentsBy_pub_parent(int dx, int dy) { QColumnView::scrollContentsBy(dx, dy); }
        ...
        int verticalOffset_pub_parent() const { return QColumnView::verticalOffset(); }
        ...
        QModelIndexList selectedIndexes_pub_parent() const { return QColumnView::selectedIndexes(); }
        ...
        void startDrag_pub_parent(Qt::DropActions supportedActions) { QColumnView::startDrag(supportedActions); }

        void dragEnterEvent_pub(QDragEnterEvent* event) { dragEnterEvent(event); }

        void dragEnterEvent_pub_parent(QDragEnterEvent* event) { QColumnView::dragEnterEvent(event); }

        void dragLeaveEvent_pub(QDragLeaveEvent* event) { dragLeaveEvent(event); }

        void dragLeaveEvent_pub_parent(QDragLeaveEvent* event) { QColumnView::dragLeaveEvent(event); }

        void dragMoveEvent_pub(QDragMoveEvent* event) { dragMoveEvent(event); }

        void dragMoveEvent_pub_parent(QDragMoveEvent* event) { QColumnView::dragMoveEvent(event); }

        void dropEvent_pub(QDropEvent* event) { dropEvent(event); }

        void dropEvent_pub_parent(QDropEvent* event) { QColumnView::dropEvent(event); }

        bool event_pub(QEvent* event_) { return event(event_); }

        bool event_pub_parent(QEvent* event_) { return QColumnView::event(event_); }

        bool eventFilter_pub(QObject* object, QEvent* event) { return eventFilter(object, event); }

        bool eventFilter_pub_parent(QObject* object, QEvent* event) { return QColumnView::eventFilter(object, event); }

        void focusInEvent_pub(QFocusEvent* event) { focusInEvent(event); }

        void focusInEvent_pub_parent(QFocusEvent* event) { QColumnView::focusInEvent(event); }

        bool focusNextPrevChild_pub(bool next) { return focusNextPrevChild(next); }

        bool focusNextPrevChild_pub_parent(bool next) { return QColumnView::focusNextPrevChild(next); }

        void focusOutEvent_pub(QFocusEvent* event) { focusOutEvent(event); }

        void focusOutEvent_pub_parent(QFocusEvent* event) { QColumnView::focusOutEvent(event); }

        void keyPressEvent_pub(QKeyEvent* event) { keyPressEvent(event); }

        void keyPressEvent_pub_parent(QKeyEvent* event) { QColumnView::keyPressEvent(event); }

        void mouseDoubleClickEvent_pub(QMouseEvent* event) { mouseDoubleClickEvent(event); }

        void mouseDoubleClickEvent_pub_parent(QMouseEvent* event) { QColumnView::mouseDoubleClickEvent(event); }

        void mouseMoveEvent_pub(QMouseEvent* event) { mouseMoveEvent(event); }

        void mouseMoveEvent_pub_parent(QMouseEvent* event) { QColumnView::mouseMoveEvent(event); }

        void mousePressEvent_pub(QMouseEvent* event) { mousePressEvent(event); }

        void mousePressEvent_pub_parent(QMouseEvent* event) { QColumnView::mousePressEvent(event); }

        void mouseReleaseEvent_pub(QMouseEvent* event) { mouseReleaseEvent(event); }

        void mouseReleaseEvent_pub_parent(QMouseEvent* event) { QColumnView::mouseReleaseEvent(event); }

        void timerEvent_pub(QTimerEvent* event) { timerEvent(event); }

        void timerEvent_pub_parent(QTimerEvent* event) { QColumnView::timerEvent(event); }

        bool viewportEvent_pub(QEvent* event) { return viewportEvent(event); }

        bool viewportEvent_pub_parent(QEvent* event) { return QColumnView::viewportEvent(event); }

        QSize viewportSizeHint_pub() const { return viewportSizeHint(); }

        QSize viewportSizeHint_pub_parent() const { return QColumnView::viewportSizeHint(); }
    ...
    inline ClassInstance* QColumnViewType::cachedInstance(const QColumnViewType::MuQtType* obj) { return obj->_obj; }
