...
namespace Mu
{
    ...
    public:
        ...
        QAbstractItemModelType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        void beginInsertColumns_pub_parent(const QModelIndex& parent, int first, int last)
        {
        ...
        void beginInsertRows_pub_parent(const QModelIndex& parent, int first, int last)
        {
            QAbstractItemModel::beginInsertRows(parent, first, last);
        }

        bool beginMoveColumns_pub(const QModelIndex& sourceParent, int sourceFirst, int sourceLast, const QModelIndex& destinationParent,
                                  int destinationChild)
        {
            return beginMoveColumns(sourceParent, sourceFirst, sourceLast, destinationParent, destinationChild);
        }

        bool beginMoveColumns_pub_parent(const QModelIndex& sourceParent, int sourceFirst, int sourceLast,
                                         const QModelIndex& destinationParent, int destinationChild)
        {
            return QAbstractItemModel::beginMoveColumns(sourceParent, sourceFirst, sourceLast, destinationParent, destinationChild);
        }

        bool beginMoveRows_pub(const QModelIndex& sourceParent, int sourceFirst, int sourceLast, const QModelIndex& destinationParent,
                               int destinationChild)
        {
            return beginMoveRows(sourceParent, sourceFirst, sourceLast, destinationParent, destinationChild);
        }

        bool beginMoveRows_pub_parent(const QModelIndex& sourceParent, int sourceFirst, int sourceLast,
                                      const QModelIndex& destinationParent, int destinationChild)
        {
            return QAbstractItemModel::beginMoveRows(sourceParent, sourceFirst, sourceLast, destinationParent, destinationChild);
        }

        void beginRemoveColumns_pub(const QModelIndex& parent, int first, int last) { beginRemoveColumns(parent, first, last); }

        void beginRemoveColumns_pub_parent(const QModelIndex& parent, int first, int last)
        {
        ...
        void beginRemoveRows_pub_parent(const QModelIndex& parent, int first, int last)
        {
        ...
        void changePersistentIndex_pub_parent(const QModelIndex& from, const QModelIndex& to)
        {
        ...
        void changePersistentIndexList_pub_parent(const QModelIndexList& from, const QModelIndexList& to)
        {
