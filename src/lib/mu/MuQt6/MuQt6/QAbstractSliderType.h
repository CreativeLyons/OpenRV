...
#ifndef __MuQt6__QAbstractSliderType__h__
#define __MuQt6__QAbstractSliderType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        int metric_pub_parent(QPaintDevice::PaintDeviceMetric m) const { return QAbstractSlider::metric(m); }
