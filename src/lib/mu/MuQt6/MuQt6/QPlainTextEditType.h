...
#ifndef __MuQt6__QPlainTextEditType__h__
#define __MuQt6__QPlainTextEditType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QPlainTextEditType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        void showEvent_pub_parent(QShowEvent* _p13) { QPlainTextEdit::showEvent(_p13); }
        ...
        QSize viewportSizeHint_pub_parent() const { return QPlainTextEdit::viewportSizeHint(); }
