...
#ifndef __MuQt6__QMenuType__h__
#define __MuQt6__QMenuType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QMenuType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        int metric_pub_parent(QPaintDevice::PaintDeviceMetric m) const { return QMenu::metric(m); }
