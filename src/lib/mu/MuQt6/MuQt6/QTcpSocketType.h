...
#ifndef __MuQt6__QTcpSocketType__h__
#define __MuQt6__QTcpSocketType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    class MuQt_QTcpSocket;

    class QTcpSocketType : public Class
    {
    public:
        typedef MuQt_QTcpSocket MuQtType;
        typedef QTcpSocket QtType;
    ...
    class MuQt_QTcpSocket : public QTcpSocket
    {
    public:
        virtual ~MuQt_QTcpSocket();
        MuQt_QTcpSocket(Pointer muobj, const CallEnvironment*, QObject* parent);
...
#endif // __MuQt__QTcpSocketType__h__
