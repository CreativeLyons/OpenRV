...
#ifndef __MuQt6__QTreeViewType__h__
#define __MuQt6__QTreeViewType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QTreeViewType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        int indexRowSizeHint_pub(const QModelIndex& index) const { return indexRowSizeHint(index); }

        int indexRowSizeHint_pub_parent(const QModelIndex& index) const { return QTreeView::indexRowSizeHint(index); }

        int rowHeight_pub(const QModelIndex& index) const { return rowHeight(index); }

        int rowHeight_pub_parent(const QModelIndex& index) const { return QTreeView::rowHeight(index); }

        void changeEvent_pub(QEvent* event) { changeEvent(event); }

        void changeEvent_pub_parent(QEvent* event) { QTreeView::changeEvent(event); }
        ...
        void dragMoveEvent_pub_parent(QDragMoveEvent* event) { QTreeView::dragMoveEvent(event); }

        int horizontalOffset_pub() const { return horizontalOffset(); }

        int horizontalOffset_pub_parent() const { return QTreeView::horizontalOffset(); }
        ...
        void keyPressEvent_pub_parent(QKeyEvent* event) { QTreeView::keyPressEvent(event); }

        void mouseDoubleClickEvent_pub(QMouseEvent* event) { mouseDoubleClickEvent(event); }

        void mouseDoubleClickEvent_pub_parent(QMouseEvent* event) { QTreeView::mouseDoubleClickEvent(event); }

        void mouseMoveEvent_pub(QMouseEvent* event) { mouseMoveEvent(event); }

        void mouseMoveEvent_pub_parent(QMouseEvent* event) { QTreeView::mouseMoveEvent(event); }

        void mousePressEvent_pub(QMouseEvent* event) { mousePressEvent(event); }

        void mousePressEvent_pub_parent(QMouseEvent* event) { QTreeView::mousePressEvent(event); }

        void mouseReleaseEvent_pub(QMouseEvent* event) { mouseReleaseEvent(event); }

        void mouseReleaseEvent_pub_parent(QMouseEvent* event) { QTreeView::mouseReleaseEvent(event); }

        void paintEvent_pub(QPaintEvent* event) { paintEvent(event); }

        void paintEvent_pub_parent(QPaintEvent* event) { QTreeView::paintEvent(event); }

        void rowsAboutToBeRemoved_pub(const QModelIndex& parent, int start, int end) { rowsAboutToBeRemoved(parent, start, end); }

        void rowsAboutToBeRemoved_pub_parent(const QModelIndex& parent, int start, int end)
        {
        ...
        void rowsInserted_pub_parent(const QModelIndex& parent, int start, int end) { QTreeView::rowsInserted(parent, start, end); }

        void scrollContentsBy_pub(int dx, int dy) { scrollContentsBy(dx, dy); }

        void scrollContentsBy_pub_parent(int dx, int dy) { QTreeView::scrollContentsBy(dx, dy); }

        QModelIndexList selectedIndexes_pub() const { return selectedIndexes(); }

        QModelIndexList selectedIndexes_pub_parent() const { return QTreeView::selectedIndexes(); }
        ...
        void setSelection_pub_parent(const QRect& rect, QItemSelectionModel::SelectionFlags command)
        {
        ...
        int sizeHintForColumn_pub_parent(int column) const { return QTreeView::sizeHintForColumn(column); }

        void timerEvent_pub(QTimerEvent* event) { timerEvent(event); }

        void timerEvent_pub_parent(QTimerEvent* event) { QTreeView::timerEvent(event); }
        ...
        int verticalOffset_pub_parent() const { return QTreeView::verticalOffset(); }

        bool viewportEvent_pub(QEvent* event) { return viewportEvent(event); }

        bool viewportEvent_pub_parent(QEvent* event) { return QTreeView::viewportEvent(event); }

        QSize viewportSizeHint_pub() const { return viewportSizeHint(); }

        QSize viewportSizeHint_pub_parent() const { return QTreeView::viewportSizeHint(); }
        ...
        void startDrag_pub_parent(Qt::DropActions supportedActions) { QTreeView::startDrag(supportedActions); }

        void dragEnterEvent_pub(QDragEnterEvent* event) { dragEnterEvent(event); }

        void dragEnterEvent_pub_parent(QDragEnterEvent* event) { QTreeView::dragEnterEvent(event); }

        void dragLeaveEvent_pub(QDragLeaveEvent* event) { dragLeaveEvent(event); }

        void dragLeaveEvent_pub_parent(QDragLeaveEvent* event) { QTreeView::dragLeaveEvent(event); }

        void dropEvent_pub(QDropEvent* event) { dropEvent(event); }

        void dropEvent_pub_parent(QDropEvent* event) { QTreeView::dropEvent(event); }

        bool event_pub(QEvent* event_) { return event(event_); }

        bool event_pub_parent(QEvent* event_) { return QTreeView::event(event_); }

        bool eventFilter_pub(QObject* object, QEvent* event) { return eventFilter(object, event); }

        bool eventFilter_pub_parent(QObject* object, QEvent* event) { return QTreeView::eventFilter(object, event); }

        void focusInEvent_pub(QFocusEvent* event) { focusInEvent(event); }

        void focusInEvent_pub_parent(QFocusEvent* event) { QTreeView::focusInEvent(event); }

        bool focusNextPrevChild_pub(bool next) { return focusNextPrevChild(next); }

        bool focusNextPrevChild_pub_parent(bool next) { return QTreeView::focusNextPrevChild(next); }

        void focusOutEvent_pub(QFocusEvent* event) { focusOutEvent(event); }

        void focusOutEvent_pub_parent(QFocusEvent* event) { QTreeView::focusOutEvent(event); }

        void resizeEvent_pub(QResizeEvent* event) { resizeEvent(event); }

        void resizeEvent_pub_parent(QResizeEvent* event) { QTreeView::resizeEvent(event); }
    ...
    inline ClassInstance* QTreeViewType::cachedInstance(const QTreeViewType::MuQtType* obj) { return obj->_obj; }
