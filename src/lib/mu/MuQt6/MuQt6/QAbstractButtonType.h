...
#ifndef __MuQt6__QAbstractButtonType__h__
#define __MuQt6__QAbstractButtonType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        int metric_pub_parent(QPaintDevice::PaintDeviceMetric m) const { return QAbstractButton::metric(m); }
