...
#ifndef __MuQt6__QTreeWidgetType__h__
#define __MuQt6__QTreeWidgetType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QTreeWidgetType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        bool dropMimeData_pub(QTreeWidgetItem* parent, int index, const QMimeData* data, Qt::DropAction action)
        {
            return dropMimeData(parent, index, data, action);
        }

        bool dropMimeData_pub_parent(QTreeWidgetItem* parent, int index, const QMimeData* data, Qt::DropAction action)
        {
        ...
        void changeEvent_pub_parent(QEvent* event) { QTreeWidget::changeEvent(event); }
        ...
        QSize viewportSizeHint_pub_parent() const { return QTreeWidget::viewportSizeHint(); }
