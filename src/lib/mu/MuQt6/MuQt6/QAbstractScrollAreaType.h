...
#ifndef __MuQt6__QAbstractScrollAreaType__h__
#define __MuQt6__QAbstractScrollAreaType__h__
#include <iostream>
#include <Mu/Class.h>
...
namespace Mu
{
    ...
    public:
        ...
        QAbstractScrollAreaType(Context* context, const char* name, Class* superClass = 0, Class* superClass2 = 0);
    ...
    public:
        ...
        void setViewportMargins_pub_parent(int left, int top, int right, int bottom)
        {
