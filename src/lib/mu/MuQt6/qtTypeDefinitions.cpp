QWidgetType* addAllQTSymbols(MuLangContext* c, Module* qt)
{
    ...
    QIODeviceBaseType* t_QIODeviceBase = new QIODeviceBaseType(c, "QIODeviceBase");
    qt->addSymbol(t_QIODeviceBase);
    QStringConverterType* t_QStringConverter = new QStringConverterType(c, "QStringConverter");
    qt->addSymbol(t_QStringConverter);
    QMatrix4x4Type* t_QMatrix4x4 = new QMatrix4x4Type(c, "QMatrix4x4");
    qt->addSymbol(t_QMatrix4x4);
    QRegularExpressionType* t_QRegularExpression = new QRegularExpressionType(c, "QRegularExpression");
    ...
    QStandardItemType* t_QStandardItem = new QStandardItemType(c, "QStandardItem");
    qt->addSymbol(t_QStandardItem);
    QListWidgetItemType* t_QListWidgetItem = new QListWidgetItemType(c, "QListWidgetItem");
    qt->addSymbol(t_QListWidgetItem);
    QTreeWidgetItemType* t_QTreeWidgetItem = new QTreeWidgetItemType(c, "QTreeWidgetItem");
    qt->addSymbol(t_QTreeWidgetItem);
    QTableWidgetItemType* t_QTableWidgetItem = new QTableWidgetItemType(c, "QTableWidgetItem");
    qt->addSymbol(t_QTableWidgetItem);
    QProcessEnvironmentType* t_QProcessEnvironment = new QProcessEnvironmentType(c, "QProcessEnvironment");
    ...
    QItemSelectionRangeType* t_QItemSelectionRange = new QItemSelectionRangeType(c, "QItemSelectionRange");
    qt->addSymbol(t_QItemSelectionRange);
    QItemSelectionType* t_QItemSelection = new QItemSelectionType(c, "QItemSelection");
    ...
    QNetworkCookieType* t_QNetworkCookie = new QNetworkCookieType(c, "QNetworkCookie");
    ...
    QCloseEventType* t_QCloseEvent = new QCloseEventType(c, "QCloseEvent", t_QEvent);
    ...
    QFileOpenEventType* t_QFileOpenEvent = new QFileOpenEventType(c, "QFileOpenEvent", t_QEvent);
    ...
    QClipboardType* t_QClipboard = new QClipboardType(c, "QClipboard", t_QObject);
    qt->addSymbol(t_QClipboard);
    QActionType* t_QAction = new QActionType(c, "QAction", t_QObject);
    qt->addSymbol(t_QAction);
    QTimerEventType* t_QTimerEvent = new QTimerEventType(c, "QTimerEvent", t_QEvent);
    ...
    QEventLoopType* t_QEventLoop = new QEventLoopType(c, "QEventLoop", t_QObject);
    qt->addSymbol(t_QEventLoop);
    QNetworkAccessManagerType* t_QNetworkAccessManager = new QNetworkAccessManagerType(c, "QNetworkAccessManager", t_QObject);
    qt->addSymbol(t_QNetworkAccessManager);
    QAbstractItemModelType* t_QAbstractItemModel = new QAbstractItemModelType(c, "QAbstractItemModel", t_QObject);
    qt->addSymbol(t_QAbstractItemModel);
    QFocusEventType* t_QFocusEvent = new QFocusEventType(c, "QFocusEvent", t_QEvent);
    qt->addSymbol(t_QFocusEvent);
    QGestureEventType* t_QGestureEvent = new QGestureEventType(c, "QGestureEvent", t_QEvent);
    qt->addSymbol(t_QGestureEvent);
    QActionGroupType* t_QActionGroup = new QActionGroupType(c, "QActionGroup", t_QObject);
    qt->addSymbol(t_QActionGroup);
    QTimerType* t_QTimer = new QTimerType(c, "QTimer", t_QObject);
    qt->addSymbol(t_QTimer);
    QDragLeaveEventType* t_QDragLeaveEvent = new QDragLeaveEventType(c, "QDragLeaveEvent", t_QEvent);
    qt->addSymbol(t_QDragLeaveEvent);
    QResizeEventType* t_QResizeEvent = new QResizeEventType(c, "QResizeEvent", t_QEvent);
    ...
    QDropEventType* t_QDropEvent = new QDropEventType(c, "QDropEvent", t_QEvent);
    qt->addSymbol(t_QDropEvent);
    QIODeviceType* t_QIODevice = new QIODeviceType(c, "QIODevice", t_QObject, t_QIODeviceBase);
    qt->addSymbol(t_QIODevice);
    QCoreApplicationType* t_QCoreApplication = new QCoreApplicationType(c, "QCoreApplication", t_QObject);
    qt->addSymbol(t_QCoreApplication);
    QCompleterType* t_QCompleter = new QCompleterType(c, "QCompleter", t_QObject);
    qt->addSymbol(t_QCompleter);
    QNetworkCookieJarType* t_QNetworkCookieJar = new QNetworkCookieJarType(c, "QNetworkCookieJar", t_QObject);
    qt->addSymbol(t_QNetworkCookieJar);
    QConicalGradientType* t_QConicalGradient = new QConicalGradientType(c, "QConicalGradient", t_QGradient);
    qt->addSymbol(t_QConicalGradient);
    QWidgetType* t_QWidget = new QWidgetType(c, "QWidget", t_QObject, t_QPaintDevice);
    qt->addSymbol(t_QWidget);
    QQuickItemType* t_QQuickItem = new QQuickItemType(c, "QQuickItem", t_QObject);
    qt->addSymbol(t_QQuickItem);
    QLayoutType* t_QLayout = new QLayoutType(c, "QLayout", t_QObject, t_QLayoutItem);
    qt->addSymbol(t_QLayout);
    QShowEventType* t_QShowEvent = new QShowEventType(c, "QShowEvent", t_QEvent);
    qt->addSymbol(t_QShowEvent);
    QTcpServerType* t_QTcpServer = new QTcpServerType(c, "QTcpServer", t_QObject);
    qt->addSymbol(t_QTcpServer);
    QTextDocumentType* t_QTextDocument = new QTextDocumentType(c, "QTextDocument", t_QObject);
    qt->addSymbol(t_QTextDocument);
    QScreenType* t_QScreen = new QScreenType(c, "QScreen", t_QObject);
    qt->addSymbol(t_QScreen);
    QButtonGroupType* t_QButtonGroup = new QButtonGroupType(c, "QButtonGroup", t_QObject);
    ...
    QAbstractSocketType* t_QAbstractSocket = new QAbstractSocketType(c, "QAbstractSocket", t_QIODevice);
    qt->addSymbol(t_QAbstractSocket);
    QAbstractTableModelType* t_QAbstractTableModel = new QAbstractTableModelType(c, "QAbstractTableModel", t_QAbstractItemModel);
    qt->addSymbol(t_QAbstractTableModel);
    QGridLayoutType* t_QGridLayout = new QGridLayoutType(c, "QGridLayout", t_QLayout);
    qt->addSymbol(t_QGridLayout);
    QKeyEventType* t_QKeyEvent = new QKeyEventType(c, "QKeyEvent", t_QInputEvent);
    qt->addSymbol(t_QKeyEvent);
    QWidgetActionType* t_QWidgetAction = new QWidgetActionType(c, "QWidgetAction", t_QAction);
    ...
    QStatusBarType* t_QStatusBar = new QStatusBarType(c, "QStatusBar", t_QWidget);
    qt->addSymbol(t_QStatusBar);
    QToolBarType* t_QToolBar = new QToolBarType(c, "QToolBar", t_QWidget);
    qt->addSymbol(t_QToolBar);
    QFormLayoutType* t_QFormLayout = new QFormLayoutType(c, "QFormLayout", t_QLayout);
    qt->addSymbol(t_QFormLayout);
    QDragMoveEventType* t_QDragMoveEvent = new QDragMoveEventType(c, "QDragMoveEvent", t_QDropEvent);
    qt->addSymbol(t_QDragMoveEvent);
    QQmlEngineType* t_QQmlEngine = new QQmlEngineType(c, "QQmlEngine", t_QJSEngine);
    qt->addSymbol(t_QQmlEngine);
    QDialogType* t_QDialog = new QDialogType(c, "QDialog", t_QWidget);
    qt->addSymbol(t_QDialog);
    QPointerEventType* t_QPointerEvent = new QPointerEventType(c, "QPointerEvent", t_QInputEvent);
    qt->addSymbol(t_QPointerEvent);
    QLocalSocketType* t_QLocalSocket = new QLocalSocketType(c, "QLocalSocket", t_QIODevice);
    qt->addSymbol(t_QLocalSocket);
    QAbstractButtonType* t_QAbstractButton = new QAbstractButtonType(c, "QAbstractButton", t_QWidget);
    qt->addSymbol(t_QAbstractButton);
    QGuiApplicationType* t_QGuiApplication = new QGuiApplicationType(c, "QGuiApplication", t_QCoreApplication);
    ...
    QSvgWidgetType* t_QSvgWidget = new QSvgWidgetType(c, "QSvgWidget", t_QWidget);
    qt->addSymbol(t_QSvgWidget);
    QNetworkReplyType* t_QNetworkReply = new QNetworkReplyType(c, "QNetworkReply", t_QIODevice);
    ...
    QAbstractSliderType* t_QAbstractSlider = new QAbstractSliderType(c, "QAbstractSlider", t_QWidget);
    qt->addSymbol(t_QAbstractSlider);
    QContextMenuEventType* t_QContextMenuEvent = new QContextMenuEventType(c, "QContextMenuEvent", t_QInputEvent);
    ...
    QAbstractListModelType* t_QAbstractListModel = new QAbstractListModelType(c, "QAbstractListModel", t_QAbstractItemModel);
    qt->addSymbol(t_QAbstractListModel);
    QMainWindowType* t_QMainWindow = new QMainWindowType(c, "QMainWindow", t_QWidget);
    qt->addSymbol(t_QMainWindow);
    QAbstractSpinBoxType* t_QAbstractSpinBox = new QAbstractSpinBoxType(c, "QAbstractSpinBox", t_QWidget);
    qt->addSymbol(t_QAbstractSpinBox);
    QProgressBarType* t_QProgressBar = new QProgressBarType(c, "QProgressBar", t_QWidget);
    qt->addSymbol(t_QProgressBar);
    QTabBarType* t_QTabBar = new QTabBarType(c, "QTabBar", t_QWidget);
    qt->addSymbol(t_QTabBar);
    QBoxLayoutType* t_QBoxLayout = new QBoxLayoutType(c, "QBoxLayout", t_QLayout);
    qt->addSymbol(t_QBoxLayout);
    QDockWidgetType* t_QDockWidget = new QDockWidgetType(c, "QDockWidget", t_QWidget);
    qt->addSymbol(t_QDockWidget);
    QVBoxLayoutType* t_QVBoxLayout = new QVBoxLayoutType(c, "QVBoxLayout", t_QBoxLayout);
    qt->addSymbol(t_QVBoxLayout);
    QApplicationType* t_QApplication = new QApplicationType(c, "QApplication", t_QGuiApplication);
    qt->addSymbol(t_QApplication);
    QToolBoxType* t_QToolBox = new QToolBoxType(c, "QToolBox", t_QFrame);
    qt->addSymbol(t_QToolBox);
    QSpinBoxType* t_QSpinBox = new QSpinBoxType(c, "QSpinBox", t_QAbstractSpinBox);
    qt->addSymbol(t_QSpinBox);
    QDialType* t_QDial = new QDialType(c, "QDial", t_QAbstractSlider);
    qt->addSymbol(t_QDial);
    QRadioButtonType* t_QRadioButton = new QRadioButtonType(c, "QRadioButton", t_QAbstractButton);
    qt->addSymbol(t_QRadioButton);
    QAbstractScrollAreaType* t_QAbstractScrollArea = new QAbstractScrollAreaType(c, "QAbstractScrollArea", t_QFrame);
    qt->addSymbol(t_QAbstractScrollArea);
    QPushButtonType* t_QPushButton = new QPushButtonType(c, "QPushButton", t_QAbstractButton);
    qt->addSymbol(t_QPushButton);
    QStackedWidgetType* t_QStackedWidget = new QStackedWidgetType(c, "QStackedWidget", t_QFrame);
    ...
    QTcpSocketType* t_QTcpSocket = new QTcpSocketType(c, "QTcpSocket", t_QAbstractSocket);
    qt->addSymbol(t_QTcpSocket);
    QColorDialogType* t_QColorDialog = new QColorDialogType(c, "QColorDialog", t_QDialog);
    qt->addSymbol(t_QColorDialog);
    QSinglePointEventType* t_QSinglePointEvent = new QSinglePointEventType(c, "QSinglePointEvent", t_QPointerEvent);
    qt->addSymbol(t_QSinglePointEvent);
    QDragEnterEventType* t_QDragEnterEvent = new QDragEnterEventType(c, "QDragEnterEvent", t_QDragMoveEvent);
    qt->addSymbol(t_QDragEnterEvent);
    QHBoxLayoutType* t_QHBoxLayout = new QHBoxLayoutType(c, "QHBoxLayout", t_QBoxLayout);
    qt->addSymbol(t_QHBoxLayout);
    QInputDialogType* t_QInputDialog = new QInputDialogType(c, "QInputDialog", t_QDialog);
    qt->addSymbol(t_QInputDialog);
    QUdpSocketType* t_QUdpSocket = new QUdpSocketType(c, "QUdpSocket", t_QAbstractSocket);
    qt->addSymbol(t_QUdpSocket);
    QFileDialogType* t_QFileDialog = new QFileDialogType(c, "QFileDialog", t_QDialog);
    qt->addSymbol(t_QFileDialog);
    QQmlApplicationEngineType* t_QQmlApplicationEngine = new QQmlApplicationEngineType(c, "QQmlApplicationEngine", t_QQmlEngine);
    qt->addSymbol(t_QQmlApplicationEngine);
    QToolButtonType* t_QToolButton = new QToolButtonType(c, "QToolButton", t_QAbstractButton);
    qt->addSymbol(t_QToolButton);
    QLabelType* t_QLabel = new QLabelType(c, "QLabel", t_QFrame);
    qt->addSymbol(t_QLabel);
    QCheckBoxType* t_QCheckBox = new QCheckBoxType(c, "QCheckBox", t_QAbstractButton);
    qt->addSymbol(t_QCheckBox);
    QSplitterType* t_QSplitter = new QSplitterType(c, "QSplitter", t_QFrame);
    qt->addSymbol(t_QSplitter);
    QPlainTextEditType* t_QPlainTextEdit = new QPlainTextEditType(c, "QPlainTextEdit", t_QAbstractScrollArea);
    qt->addSymbol(t_QPlainTextEdit);
    QMouseEventType* t_QMouseEvent = new QMouseEventType(c, "QMouseEvent", t_QSinglePointEvent);
    qt->addSymbol(t_QMouseEvent);
    QAbstractItemViewType* t_QAbstractItemView = new QAbstractItemViewType(c, "QAbstractItemView", t_QAbstractScrollArea);
    qt->addSymbol(t_QAbstractItemView);
    QTabletEventType* t_QTabletEvent = new QTabletEventType(c, "QTabletEvent", t_QSinglePointEvent);
    qt->addSymbol(t_QTabletEvent);
    QTextEditType* t_QTextEdit = new QTextEditType(c, "QTextEdit", t_QAbstractScrollArea);
    qt->addSymbol(t_QTextEdit);
    QScrollAreaType* t_QScrollArea = new QScrollAreaType(c, "QScrollArea", t_QAbstractScrollArea);
    qt->addSymbol(t_QScrollArea);
    QWheelEventType* t_QWheelEvent = new QWheelEventType(c, "QWheelEvent", t_QSinglePointEvent);
    qt->addSymbol(t_QWheelEvent);
    QHoverEventType* t_QHoverEvent = new QHoverEventType(c, "QHoverEvent", t_QSinglePointEvent);
    qt->addSymbol(t_QHoverEvent);
    QTableViewType* t_QTableView = new QTableViewType(c, "QTableView", t_QAbstractItemView);
    qt->addSymbol(t_QTableView);
    QColumnViewType* t_QColumnView = new QColumnViewType(c, "QColumnView", t_QAbstractItemView);
    qt->addSymbol(t_QColumnView);
    QTreeViewType* t_QTreeView = new QTreeViewType(c, "QTreeView", t_QAbstractItemView);
    qt->addSymbol(t_QTreeView);
    QListViewType* t_QListView = new QListViewType(c, "QListView", t_QAbstractItemView);
    qt->addSymbol(t_QListView);
    QHeaderViewType* t_QHeaderView = new QHeaderViewType(c, "QHeaderView", t_QAbstractItemView);
    qt->addSymbol(t_QHeaderView);
    QTextBrowserType* t_QTextBrowser = new QTextBrowserType(c, "QTextBrowser", t_QTextEdit);
    qt->addSymbol(t_QTextBrowser);
    QListWidgetType* t_QListWidget = new QListWidgetType(c, "QListWidget", t_QListView);
    qt->addSymbol(t_QListWidget);
    QTableWidgetType* t_QTableWidget = new QTableWidgetType(c, "QTableWidget", t_QTableView);
    qt->addSymbol(t_QTableWidget);
    QTreeWidgetType* t_QTreeWidget = new QTreeWidgetType(c, "QTreeWidget", t_QTreeView);
